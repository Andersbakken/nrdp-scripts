;;; nrdp-claude-code.el --- Claude Code IDE integration  -*- lexical-binding: t; -*-
...
;; use-package with :straight requires the straight.el integration at
;; macro-expand time, which isn't available during batch byte-compilation.
;; Wrap in eval to defer expansion to runtime.
(eval
