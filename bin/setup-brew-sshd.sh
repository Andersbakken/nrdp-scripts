...
cat $SCRIPT_DIR/org.openssh.sshd.plist | sudo tee /Library/LaunchDaemons/org.openssh.sshd.plist >/dev/null
cat $SCRIPT_DIR/sshd_config | sudo tee /opt/homebrew/etc/ssh/sshd_config >/dev/null
